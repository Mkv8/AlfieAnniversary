...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Whatify',				'WhatIcon',			'Programmer, helped with the ourple guy song and more',	'https://twitter.com/Sonamaker1',		'8A5F5C'],
			...
			['SplatterDash',		'blank',			'Made INTERRUPTED and All Saints Scramble Remix',		'https://mobile.twitter.com/splatterdash_ng',	'FF3021'],
			...
			['Chubby',				'blank',			'Charter for Interruped Spooks',						'https://twitter.com/ChubbyAlt',		'C78A58'],
			...
			['Ourple Guy team',						'guy',				'Thanks to Saruky for letting us use ourple guy, press ENTER for the mod page!','https://gamebanana.com/mods/357511',			'FF3021'],
