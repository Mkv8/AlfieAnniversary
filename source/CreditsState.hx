...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Aidan.XD',				'aidan',			'Spectral Sonnet Beta',									'https://www.youtube.com/channel/UCvIvCI3NRiJEYpyes58LhqQ',	'FF9D87'],
			...
			['PpavlikosS',			'pav',				'Charter for Forest Fire, Spectral Beta and GOATED',			'https://twitter.com/ppavlikoss',		'BAE2FF'],
			['Sayge',				'sayge',			'Charter for Spectral Sonnet',							'https://twitter.com/Sayge3D',			'FFA44F'],
			[''],
			['Special Thanks'],
