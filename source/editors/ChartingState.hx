...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['hearts', "emmits hearts,\n v1 is timer length v2 is how many times it should play"],
		['alfiefuckery', "YERAAAHHHI!HPI!!!!! val1 (on/off)"],
		...
		['Change Char EX', "Value 1: Character to change (Dad, BF, GF)\nValue 2: New character's name"],
		['Black Bars', "Value 1: Amount, takes number as pixels, number% as percent\nValue 2: duration, ease leave empty for instant"],
	...
	**/
	...
	override function create()
	{
		...
		bpmTxt = new FlxFixedText(1000, 50, 0, "", 16);
		...
		zoomTxt = new FlxFixedText(10, 10, 0, "Zoom: 1x", 16);
	...
	function addSongUI():Void
	{
		...
		{
			if(Paths.formatToSongPath(_song.song) == "kinda-fruity") {
	...
	{
		if(Paths.formatToSongPath(song) == "kinda-fruity") {
			CoolUtil.browserLoad("https://www.youtube.com/watch?v=dQw4w9WgXcQ");
			return;
		}
