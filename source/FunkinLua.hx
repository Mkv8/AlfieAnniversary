...
final _point:FlxPoint = new FlxPoint();
...
class FunkinLua {
	...
	public static var currentScript:FunkinLua;
	...
	public function new(script:String) {
		...
		set('luaDebugMode', false/*#if debug true #else false #end*/);
		...
		/* 
		//Removed in later versions of FunkinLua I guess
